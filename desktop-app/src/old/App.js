...
import loadModel from "./utils-general/loadModel";
import getAvailableCameras from "./utils-general/getAvailableCameras";
import "./styles/App.css";
import setCameraRefSource from "./utils-general/setCameraRefSource";
import CameraChooser from "./components/CameraChooser";
import setupAndModelsLoop from "./runModels";
				...
				{!isODModelLoading.loading && <button
					onClick={
						() => {
							...
							setupAndModelsLoop(cameraRef.current, model, canvasRef.current, modelsLoopToggleRef);
						}
					}> Start
				</button>}
				{!isODModelLoading.loading && <button
